(function($){
    ...
    */
    ...
    function initialize_field( $el ) {
        ...
        $el.find('#acf__gmb-oauth').on( 'click', function(){
            oauth_do_request();
        });

        $el.find('#acf__gmb-oauth--delete').on( 'click', function(){
    ...
    /**
     * Run AJAX request onto the delete_gmb_oauth_transients endpoint
     * 
     * This will clear out all transient tokens for gmb OAuth.
     */
